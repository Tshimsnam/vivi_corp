              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{ route('services.create') }}" class="btn btn-primary btn-rounded btn-fw">Nouveau</a>
                    </div>
                    </p>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton8">
                                <h6 class="dropdown-header">{{$service->content}}</h6>
                              </div>
                            </div>
                          </td>
                          <td >
                            <form action="" method="POST">
                                <a class="btn btn-info btn-sm edit-btn" href="#" data-toggle="modal"
                                    data-target="#edit-{{ $service->name }}" form="edit-{{ $service->name }}">
                                     <i class="mdi mdi-eye"></i>
                                </a>
                                @csrf
                                @method('DELETE')
